...
public class UpcomingCalendarEventsParser extends AbstractApiParser<UpcomingCalendarEventsResponse, Collection<IUpcomingCalendarEvent>> {
  public UpcomingCalendarEventsParser(ApiConnector connector) {
    super(connector, UpcomingCalendarEventsResponse.class, ApiEndpoint.CHR_UPCOMING_CALENDAR_EVENTS_V2);
  }
