...
public class TestFacWarStats extends ApiTestSetup {
	...
	public void testGetFacWarStats() throws IOException, ParseException,
		...
		// Perform test
		ApiTestConnector.testComparison(ApiTestConnector.CORP_FAC_WAR_STATS_CTL,
				ApiTestConnector.CORP_FAC_WAR_STATS_TST,
				ApiTestConnector.CORP_FAC_WAR_STATS_OUT, testData);
	}
