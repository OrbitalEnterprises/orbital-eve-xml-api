...
public class CharKilllogConverter extends ResponseConverter {

  public static String convert(ICharacterAPI request, Collection<IKill> response) {
      ...
      for (IKill next : response) {
        ...
        if (attackers.size() == 0)
          ...
          for (IKillAttacker nextA : attackers) {
            ...
            // Factions don't always exist in input data
