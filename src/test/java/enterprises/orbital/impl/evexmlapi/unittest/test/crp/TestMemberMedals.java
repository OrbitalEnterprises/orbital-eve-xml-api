...
public class TestMemberMedals extends ApiTestSetup {
	...
	@Test
	public void testGetMemberMedals() throws IOException, ParseException,
			SAXException {
		// Retrieve response
		...
		// Perform test
		ApiTestConnector.testComparison(ApiTestConnector.CORP_MEMBER_MEDALS_CTL,
				ApiTestConnector.CORP_MEMBER_MEDALS_TST,
				ApiTestConnector.CORP_MEMBER_MEDALS_OUT, testData);
	}
