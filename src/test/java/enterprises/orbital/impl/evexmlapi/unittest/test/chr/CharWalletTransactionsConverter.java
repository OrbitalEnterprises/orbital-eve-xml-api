...
public class CharWalletTransactionsConverter extends ResponseConverter {
	...
	public static String convert(ICharacterAPI request,
		...
		builder.append("<rowset name=\"transactions\" key=\"transactionID\" columns=\"transactionDateTime,transactionID,quantity,typeName,typeID,price,clientID,clientName,stationID,stationName,transactionType,transactionFor,journalTransactionID\"");
