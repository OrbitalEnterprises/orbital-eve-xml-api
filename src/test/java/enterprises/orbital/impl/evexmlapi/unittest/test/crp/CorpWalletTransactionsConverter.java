...
public class CorpWalletTransactionsConverter extends ResponseConverter {
  ...
  public static String convert(
    ...
    builder
        .append("<rowset name=\"transactions\" key=\"transactionID\" columns=\"transactionDateTime,transactionID,quantity,typeName,typeID,price,clientID,clientName,characterID,characterName,stationID,stationName,transactionType,transactionFor,journalTransactionID,clientTypeID\"");
    ...
    if (response.size() == 0)
      ...
      for (IWalletTransaction next : response) {
        ...
        builder.append("\" characterID=\"").append(next.getCharacterID());
