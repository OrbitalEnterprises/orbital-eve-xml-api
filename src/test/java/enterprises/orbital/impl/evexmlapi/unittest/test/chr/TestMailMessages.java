...
public class TestMailMessages extends ApiTestSetup {
	...
	@Test
	public void testGetMailMessages() throws IOException, ParseException,
			SAXException {
		// Retrieve response
		...
		// Perform test
		ApiTestConnector.testComparison(ApiTestConnector.CHAR_MAIL_MESSAGES_CTL,
				ApiTestConnector.CHAR_MAIL_MESSAGES_TST,
				ApiTestConnector.CHAR_MAIL_MESSAGES_OUT, testData);
	}
