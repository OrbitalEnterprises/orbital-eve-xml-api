...
public class TestFacWarStats extends ApiTestSetup {
	...
	public void testGetFacWarStats() throws IOException, ParseException,
		...
		// Perform test
		ApiTestConnector.testComparison(ApiTestConnector.CHAR_FAC_WAR_STATS_CTL,
				ApiTestConnector.CHAR_FAC_WAR_STATS_TST,
				ApiTestConnector.CHAR_FAC_WAR_STATS_OUT, testData);
	}
