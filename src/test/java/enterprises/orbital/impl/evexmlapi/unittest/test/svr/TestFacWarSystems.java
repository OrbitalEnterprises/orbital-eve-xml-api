...
public class TestFacWarSystems extends ApiTestSetup {
	...
	@Test
	public void testGetFacWarSystems() throws IOException, ParseException,
			SAXException {
		// Retrieve response
		...
		// Perform test
		ApiTestConnector.testComparison(ApiTestConnector.MAP_FAC_WAR_SYSTEMS_CTL,
				ApiTestConnector.MAP_FAC_WAR_SYSTEMS_TST,
				ApiTestConnector.MAP_FAC_WAR_SYSTEMS_OUT, testData);
	}
