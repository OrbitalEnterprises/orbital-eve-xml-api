...
public class TestAccountStatus extends ApiTestSetup {
	...
	@Test
	public void testGetAccountStatus() throws IOException, ParseException,
			SAXException {
		// Retrieve response
		...
		// Perform test
		ApiTestConnector.testComparison(ApiTestConnector.ACCT_ACCOUNT_STATUS_CTL,
				ApiTestConnector.ACCT_ACCOUNT_STATUS_TST,
				ApiTestConnector.ACCT_ACCOUNT_STATUS_OUT, testData);
	}
