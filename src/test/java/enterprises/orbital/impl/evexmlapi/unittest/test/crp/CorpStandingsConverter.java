...
public class CorpStandingsConverter extends ResponseConverter {

  public static String convert(ICorporationAPI request, IStandingSet response) {
    ...
    if (response.getAgentStandings().size() == 0 && response.getNPCCorporationStandings().size() == 0 && response.getFactionStandings().size() == 0)
      ...
      builder.append(">\n");
      builder.append("<corporationNPCStandings>\n");
