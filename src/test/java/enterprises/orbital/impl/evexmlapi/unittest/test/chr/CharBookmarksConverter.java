...
public class CharBookmarksConverter extends ResponseConverter {
  ...
  public static String convert(ICharacterAPI request, Collection<IBookmarkFolder> response) {
    StringBuilder builder = new StringBuilder();

    convertOpener(request, builder);
    builder.append("<result>\n");
    builder.append("<rowset name=\"folders\" key=\"folderID\" columns=\"folderName\"");
    if (response.size() > 0) {
      builder.append(">\n");
