...
public class TestContractItems extends ApiTestSetup {
  ...
  public void testGetContractItems() throws IOException, ParseException, SAXException {
    ...
    // Perform test
    ApiTestConnector.testComparison(ApiTestConnector.CORP_CONTRACT_ITEMS_CTL, ApiTestConnector.CORP_CONTRACT_ITEMS_TST, ApiTestConnector.CORP_CONTRACT_ITEMS_OUT, testData);
  }
