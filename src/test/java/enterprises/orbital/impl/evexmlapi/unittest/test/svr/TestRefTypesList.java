...
public class TestRefTypesList extends ApiTestSetup {
	...
	@Test
	public void testGetRefTypesList() throws IOException, ParseException,
			SAXException {
		// Retrieve response
		...
		// Perform test
		ApiTestConnector.testComparison(ApiTestConnector.EVE_REF_TYPES_CTL,
				ApiTestConnector.EVE_REF_TYPES_TST,
				ApiTestConnector.EVE_REF_TYPES_OUT, testData);
	}
