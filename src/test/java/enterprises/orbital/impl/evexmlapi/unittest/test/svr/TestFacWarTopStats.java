...
public class TestFacWarTopStats extends ApiTestSetup {
	...
	public void testGetFacWarStats() throws IOException, ParseException,
		...
		// Perform test
		ApiTestConnector.testComparison(ApiTestConnector.EVE_FAC_WAR_TOP_STATS_CTL,
				ApiTestConnector.EVE_FAC_WAR_TOP_STATS_TST,
				ApiTestConnector.EVE_FAC_WAR_TOP_STATS_OUT, testData);
	}
